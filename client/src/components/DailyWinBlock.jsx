function DailyWinBlock({ route, timer, startPage, endPage }) {
    ...
    return (
        <>
            ...
            <p>You got from {startPage} to {endPage} in <span className="daily-stat">{timer}</span>, travelling through <span className="daily-stat">{route.length-1}</span> pages, and following this path:</p>
